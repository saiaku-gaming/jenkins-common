...
/home/jenkins/.local/bin/aws gamelift put-scaling-policy --name "Scale down" --fleet-id "$FLEET_ID" --scaling-adjustment "0" --scaling-adjustment-type "ExactCapacity" --threshold "0" --comparison-operator "LessThanOrEqualToThreshold" --evaluation-periods "20" --metric-name "ActiveGameSessions"
