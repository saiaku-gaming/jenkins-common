...
aws gamelift put-scaling-policy --name "Scale down" --fleet-id "$FLEET_ID" --scaling-adjustment "-1" --scaling-adjustment-type "ChangeInCapacity" --threshold "0" --comparison-operator "LessThanOrEqualToThreshold" --evaluation-periods "120" --metric-name "ActiveGameSessions"
